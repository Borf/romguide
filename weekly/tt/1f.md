...
Race: 
Size: Large  
Recommended settings: character models off, effects off, protect party off
...
The valkyrie has a skill where it puts a red area on the floor. This red area will damage you when you stand on it, and if the valkyrie stands on it, the  energy meter of the valk will go up. When the energy reaches 100%, the party loses. This is why it is better to kite the valkyrie around in the first phase, to make sure it does not stay on the red zone.
...
- The common classes for chain baiting are Warlock and Archbishop. Warlocks have white barrier to negate any damage done by the fire puddles, and Archbishops can outheal the fire damage for a while
...
- (Legend) When the entry dialog opens, make sure everybody clicks ready except for the chain baiter
- (Legend) Party leader clicks accept and everybody gets teleported in
- (Legend) Everybody walks to the circle in the bottom of the arena, but do **not** start the battle
- (Legend) When you see everybody has moved (this means they finished loading), call in the chain baiter
- (Legend) Wait for the chain baiter to join up and star the battle

If, during the battle, anyone besides the chain baiter gets chained, it is better to restart the battle. If you notice the chain baiter does not get the chain bait, call everybody to leave the map and do the entry process again.
